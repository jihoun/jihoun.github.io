...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pigs-pigs-module"], {
    ...
    var MatIconRegistry = /*#__PURE__*/function () {
      ...
      _createClass(MatIconRegistry, [{
        ...
        value: function getSvgIconFromUrl(safeUrl) {
          ...
          */
          function (svg) {
            return _this19._cachedIconsByUrl.set(
            /** @type {?} */
            url, svg);
        ...
        value: function _getSvgFromIconSetConfigs(name, iconSetConfigs) {
          ...
          */
          function (iconSetConfig) {
            return _this20._loadSvgIconSetFromConfig(iconSetConfig).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(
            /**
            * @param {?} err
            * @return {?}
            */
            function (err) {
              /** @type {?} */
              var url = _this20._sanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_0__["SecurityContext"].RESOURCE_URL, iconSetConfig.url); // Swallow errors fetching individual URLs so the
          ...
          */
          function () {
            /** @type {?} */
            var foundIcon = _this20._extractIconWithNameFromAnySet(name, iconSetConfigs);
        ...
        value: function _loadSvgIconFromConfig(config) {
          ...
          */
          function (svgText) {
            return _this21._createSvgElementForSingleIcon(svgText, config.options);
          }));
        }
        /**
        ...
        value: function _loadSvgIconSetFromConfig(config) {
          ...
          */
          function (svgText) {
            ...
            if (!config.svgElement) {
              config.svgElement = _this22._svgElementFromString(svgText);
            }
        ...
        value: function _fetchUrl(safeUrl) {
          ...
          */
          function () {
            return _this23._inProgressUrlFetches["delete"](url);
    ...
    */
    ...
    var MatIcon = /*#__PURE__*/function (_MatIconMixinBase2) {
      ...
      function MatIcon(elementRef, _iconRegistry, ariaHidden, _location, _errorHandler) {
        ...
        _this24 = _super4.call(this, elementRef);
        _this24._iconRegistry = _iconRegistry;
        _this24._location = _location;
        _this24._errorHandler = _errorHandler;
        _this24._inline = false; // If the user has not explicitly set aria-hidden, mark the icon as hidden, as this is
        ...
        value: function ngOnChanges(changes) {
          ...
          if (svgIconChanges) {
            if (this.svgIcon) {
              ...
              */
              function (svg) {
                return _this25._setSvgElement(svg);
              },
              /**
              * @param {?} err
              * @return {?}
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015InputJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatInput = /*#__PURE__*/function (_MatInputMixinBase2) {
      ...
      function MatInput(_elementRef, _platform, ngControl, _parentForm, _parentFormGroup, _defaultErrorStateMatcher, inputValueAccessor, _autofillMonitor, ngZone) {
        ...
        _this26 = _super6.call(this, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl);
        ...
        _this26._isServer = false;
        /**
         * Whether the component is a native html select.
         */

        _this26._isNativeSelect = false;
        /**
        ...
        _this26._neverEmptyInputTypes = ['date', 'datetime', 'datetime-local', 'month', 'time', 'week'].filter(
        /**
        * @param {?} t
        * @return {?}
        */
        ...
        var element = _this26._elementRef.nativeElement; // If no input value accessor was explicitly specified, use the element as the input value
        // accessor.
        ...
        _this26._isNativeSelect = element.nodeName.toLowerCase() === 'select';
  ...
  function srcAppPigsListPigListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pigs_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../pigs.service */
    ...
    PigListComponent.ɵfac = function PigListComponent_Factory(t) {
      return new (t || PigListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_pigs_service__WEBPACK_IMPORTED_MODULE_1__["PigsService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PigListComponent, [{
        ...
        return [{
          type: _pigs_service__WEBPACK_IMPORTED_MODULE_1__["PigsService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppPigsPigsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _detail_pig_detail_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./detail/pig-detail.component */
    "./src/app/pigs/detail/pig-detail.component.ts");
    /* harmony import */


    var _list_pig_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./list/pig-list.component */
    "./src/app/pigs/list/pig-list.component.ts");
    /* harmony import */


    var _pigs_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./pigs.component */
    "./src/app/pigs/pigs.component.ts");
    ...
    var routes = [{
      ...
      children: [{
        path: 'list',
        component: _list_pig_list_component__WEBPACK_IMPORTED_MODULE_9__["PigListComponent"]
      }, {
        path: 'detail/:id',
        component: _detail_pig_detail_component__WEBPACK_IMPORTED_MODULE_8__["PigDetailComponent"]
      }, {
        path: '',
        redirectTo: 'list'
      }]
    ...
    PigsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forChild(routes), _angular_material_list__WEBPACK_IMPORTED_MODULE_5__["MatListModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_2__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_4__["MatInputModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_3__["MatIconModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_6__["MatSelectModule"]]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](PigsModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_5__["MatListModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_2__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_4__["MatInputModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_3__["MatIconModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_6__["MatSelectModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppPigsPigsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pig_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./pig.model */
    "./src/app/pigs/pig.model.ts"); // export interface
    ...
    var PigsService = /*#__PURE__*/function () {
      function PigsService() {
        ...
        this.pigs = [{
          id: '112',
          birth: new Date(),
          gender: _pig_model__WEBPACK_IMPORTED_MODULE_2__["Gender"].female
        }, {
          id: '2',
          birth: new Date(),
          gender: _pig_model__WEBPACK_IMPORTED_MODULE_2__["Gender"].male
        }, {
          id: '3',
          birth: new Date(),
          gender: _pig_model__WEBPACK_IMPORTED_MODULE_2__["Gender"].female
